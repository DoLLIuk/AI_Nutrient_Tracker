...
AI Nutrient Tracker — mobile nutrition diary для iOS и Android. Пользователь фотографирует еду или добавляет её вручную, получает калории и БЖУ, видит прогресс дня и историю приёмов пищи.
